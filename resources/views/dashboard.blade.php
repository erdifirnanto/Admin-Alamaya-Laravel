                                   ...
                                   <tbody id="table-body" style="text-transform: capitalize">
                                       ...
                                       @forelse ($projects as $key => $project)
                                           <tr style="height: 80px;">
                                                   ...
                                                   <div class="accordion" id="accordionExample1">
                                                       <h2 class="accordion-header" id="headingOne1">
                                                           <button class="accordion-button collapsed" type="button"
                                                               ...
                                                               data-bs-target="#{{ $project->id }}" aria-expanded="false"
                                                       ...
                                                       <div class="accordion-item">
                                                           <div id="{{ $project->id }}" class="accordion-collapse collapse"
                                                               ...
                                                               <div
                                                                   class="accordion-body justify-content-between align-items-center">
                                                                   <div>
                                               ...
                                               <td style="align-content: center;">{{ $project->project_handler }}
                                               </td>
                                               <td style="align-content: center;">
