   ...
   @section('content')
               ...
               <div class="row">
                   <div class="col-12 col-md-12">
                       <div class="search-add-sort-container">
                           <!-- Search Input -->
                           @include('components.completed.search-completed')
                           <!-- Buttons Section -->
        ...
        <tr style="height: 80px;">
            ...
            <td style="align-content: center">
                <div class="dropdown text-center">
                    @include('components.completed.edit-completed')
                </div>
            </td>
        </tr>
    @empty
        <tr>
            <td colspan="7" class="text-center" style="height: 80px; align-content: center;">
    ...
    @endforelse
                       ...
                       {{-- Pagination --}}
            @include('components.completed.pagination-completed')
                   </div>
               </div>
           </div>
       </section>
