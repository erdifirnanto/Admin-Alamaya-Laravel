                                   ...
                                   <tr style="height: 80px;">
                                       ...
                                       <td style="align-content: center; text-transform: capitalize;" data-key="status">
                                           <div class="btn rounded-5 align-top d-flex justify-content-center align-items-center"
                                               ...
                                               @elseif ($hosting->status == 'in_active')
                                                   <p style="margin: 0; color: rgb(255, 213, 25); font-size:14px;">In
                                                       Active
                                                   </p>
                                               @elseif ($hosting->status == 'expired')
                                                   <p style="margin: 0; color: rgb(230, 34, 8); font-size:14px;">Expired
                                                   </p>
                                               @elseif ($hosting->status == 'redemtion')
                                                   <p style="margin: 0; color: rgb(0, 102, 255) ; font-size:14px;">
                                                       Redemtion
                                                   </p>
                                               @endif
                                           </div>
                                       ...
                                       <td style="align-content: center" data-key="join_date">{{ $hosting->join_date }}

                                       </td>
                                       <td style="align-content: center" data-key="Expired">{{ $hosting->expired }}
                                       </td>
